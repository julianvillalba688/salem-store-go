...
export const PremiumFooter = () => {
  return (
    <footer className="relative bg-salem-ink text-salem-ivory pt-32 pb-12 px-6 lg:px-12 overflow-hidden z-10 -mt-20 clip-diagonal">
      <div className="absolute inset-0 opacity-5 pointer-events-none" style={{
        backgroundImage: 'url("data:image/svg+xml,%3Csvg viewBox=\'0 0 200 200\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cfilter id=\'noiseFilter\'%3E%3CfeTurbulence type=\'fractalNoise\' baseFrequency=\'0.65\' numOctaves=\'3\' stitchTiles=\'stitch\'/%3E%3C/filter%3E%3Crect width=\'100%25\' height=\'100%25\' filter=\'url(%23noiseFilter)\'/%3E%3C/svg%3E")'
      }}></div>

      <div className="max-w-[1600px] mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8 mb-32 pt-20">
          ...
          <div>
            <h3 className="font-sans text-[10px] tracking-[0.2em] uppercase text-salem-gold mb-8">Contacto</h3>
            <ul className="space-y-4 font-sans text-xs tracking-widest uppercase text-salem-beige/70">
              <li>
        ...
        <div className="w-full border-t border-white/5 pt-16 flex flex-col items-center">
           <motion.h2 
            ...
            className="font-serif text-[13vw] leading-none text-center text-white/5 tracking-tighter w-full overflow-hidden whitespace-nowrap transform-gpu"
          >
            SALEM STORE
          </motion.h2>
          ...
          <div className="w-full flex flex-col md:flex-row justify-between items-center text-[10px] font-sans text-salem-muted tracking-widest uppercase mt-8">
            ...
            <p className="mt-4 md:mt-0">Premium Editorial Frontend.</p>
          </div>
        </div>
      </div>
    </footer>
