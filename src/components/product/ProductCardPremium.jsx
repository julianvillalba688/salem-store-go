  ...
  return (
    <div className="group flex flex-col relative w-full h-full">
      <Link to={`/product/${product.slug || product.id}`} className="block relative overflow-hidden bg-salem-beige/10 aspect-[3/4] mb-6 rounded-sm">
        ...
        <div className="absolute inset-0 border border-salem-gold opacity-0 scale-95 group-hover:opacity-30 group-hover:scale-100 transition-all duration-700 ease-[0.16,1,0.3,1] z-30 pointer-events-none"></div>
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-salem-ink/30 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 z-10" />
